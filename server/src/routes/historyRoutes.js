...
const { donorRequest, patientRequest, getRequestsHistory, getDonationsHistory, dashboardStats, getSlots } = require('../controllers/historyController');
...
historyRouter.get('/slots/', getSlots);
